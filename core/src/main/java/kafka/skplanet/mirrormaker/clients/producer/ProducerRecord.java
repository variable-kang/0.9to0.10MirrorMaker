 ...
 * the topic.
 * <li>
 * If the topic is configured to use {@link TimestampType#CREATE_TIME CreateTime},
 * the timestamp in the producer record will be used by the broker.
 * </li>
 * <li>
 * If the topic is configured to use {@link TimestampType#LOG_APPEND_TIME LogAppendTime},
