 ...
 */
package kafka.skplanet.mirrormaker.common.protocol;

import kafka.skplanet.mirrormaker.common.protocol.types.ArrayOf;
import kafka.skplanet.mirrormaker.common.protocol.types.Field;
import kafka.skplanet.mirrormaker.common.protocol.types.Schema;
import kafka.skplanet.mirrormaker.common.protocol.types.Type;
...
import static kafka.skplanet.mirrormaker.common.protocol.types.Type.*;
...
public class Protocol {
    ...
    public static final Schema SASL_HANDSHAKE_RESPONSE_V0 = new Schema(
            new Field("error_code", INT16),
            new Field("enabled_mechanisms", new ArrayOf(STRING), "Array of mechanisms enabled in the server."));
