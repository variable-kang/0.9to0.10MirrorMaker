...
package kafka.skplanet.mirrormaker.common.security.authenticator;

import kafka.skplanet.mirrormaker.common.KafkaException;
import kafka.skplanet.mirrormaker.common.config.SaslConfigs;
import kafka.skplanet.mirrormaker.common.errors.AuthenticationException;
import kafka.skplanet.mirrormaker.common.errors.IllegalSaslStateException;
import kafka.skplanet.mirrormaker.common.errors.UnsupportedSaslMechanismException;
import kafka.skplanet.mirrormaker.common.errors.UnsupportedVersionException;
import kafka.skplanet.mirrormaker.common.network.*;
import kafka.skplanet.mirrormaker.common.protocol.ApiKeys;
import kafka.skplanet.mirrormaker.common.protocol.Errors;
import kafka.skplanet.mirrormaker.common.protocol.Protocol;
import kafka.skplanet.mirrormaker.common.protocol.types.SchemaException;
import kafka.skplanet.mirrormaker.common.requests.*;
import kafka.skplanet.mirrormaker.common.security.auth.AuthCallbackHandler;
import kafka.skplanet.mirrormaker.common.security.auth.KafkaPrincipal;
import kafka.skplanet.mirrormaker.common.security.auth.PrincipalBuilder;
import kafka.skplanet.mirrormaker.common.security.kerberos.KerberosName;
import kafka.skplanet.mirrormaker.common.security.kerberos.KerberosShortNamer;
            ...
            try {
                saslServer = Subject.doAs(subject, new PrivilegedExceptionAction<SaslServer>() {
                    public SaslServer run() throws SaslException {
                        return Sasl.createSaslServer(saslMechanism, "org/apache/kafka", host, configs, callbackHandler);
                    }
                });
