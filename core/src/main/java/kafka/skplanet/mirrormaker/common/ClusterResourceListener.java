...
package kafka.skplanet.mirrormaker.common;

import kafka.skplanet.mirrormaker.clients.producer.KafkaProducer;
import kafka.skplanet.mirrormaker.clients.producer.ProducerInterceptor;
import kafka.skplanet.mirrormaker.common.metrics.MetricsReporter;
import kafka.skplanet.mirrormaker.common.serialization.Deserializer;
 ...
 * <p>
 * {@link ProducerInterceptor} : The {@link ClusterResourceListener#onUpdate(ClusterResource)} method will be invoked after {@link ProducerInterceptor#onSend(ProducerRecord)}
 ...
 * <p>
 * {@link Serializer} : The {@link ClusterResourceListener#onUpdate(ClusterResource)} method will be invoked before {@link Serializer#serialize(String, Object)}
 * <p>
 * {@link Deserializer} : The {@link ClusterResourceListener#onUpdate(ClusterResource)} method will be invoked before {@link Deserializer#deserialize(String, byte[])}
 * <p>
 * {@link MetricsReporter} : The {@link ClusterResourceListener#onUpdate(ClusterResource)} method will be invoked after first {@link KafkaProducer#send(ProducerRecord)} invocation for Producer metrics reporter
 ...
 * <p>
 * {@link MetricsReporter} : The {@link ClusterResourceListener#onUpdate(ClusterResource)} method will be invoked during the bootup of the Kafka broker. The reporter may receive metric events from the network layer before this method is invoked.
 */
